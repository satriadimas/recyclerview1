...
const { outgoing, getOutgoing, destroy } = useWarehouse();
...
const deleteOutgoing = async (id) => {
    ...
    await destroy("outgoing", id);
    await getOutgoing(params);
};
